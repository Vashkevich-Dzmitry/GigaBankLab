...
namespace GigaBankLab.Services
    {
        public class DepositContractsService
        {
            ...
            public DepositContractsService(GigaBankLabContext context, CurrentDateService dateService, AccountsService accountsService, TransactionsService transactionsService)
            {
